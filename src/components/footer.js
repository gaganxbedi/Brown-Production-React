      ...
      >
        <div className={styles['bottom-container']}>
          <div className={styles['left-side']}>
            ...
            <div className={styles['SocialMedia']}>
              <span className={styles['text01']}>Follow market1</span>
          ...
          <div className={styles['Links']}>
            <div className={styles['container1']}>
              <span className={styles['text02']}>Product</span>
              ...
              <span
                className={` ${styles['text08']} ${projectStyles['footer-link']} `}
              >
                Workshops
              </span>
            </div>
        ...
        <div className={styles['Copyright']}>
          <span className={styles['text17']}>
            ...
            >
              <span className={styles['text21']}>@TeleportHQ.</span>
            </a>
            <span>
              <span>
                {' '}
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className={styles['text25']}>Vercel</span>
            </a>
            <span>
              <span>
                . Image source:
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className={styles['text29']}>Unsplash</span>
            </a>
            <span>.</span>
          </span>
        </div>
